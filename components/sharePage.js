  ...
  return (
    <React.Fragment>
      <a
        href={
          mobile
            ? `whatsapp://send?text=https://xgohorse.com`
            : `https://wa.me/?text=https://xgohorse.com`
        }
        className="whatsapp"
      />
      ...
      <TelegramShareButton url={`https://xgohorse.com`} quote={t("share-page")}>
        <svg viewBox="0 0 64 64" width="32" height="32">
          <g>
      ...
      <LinkedinShareButton url={`https://xgohorse.com`} quote={t("share-page")}>
        <svg viewBox="0 0 64 64" width="32" height="32">
          <g>
      ...
      <TwitterShareButton url={`https://xgohorse.com`} quote={t("share-page")}>
        <svg viewBox="0 0 64 64" width="32" height="32">
          <g>
      ...
      <RedditShareButton url={`https://xgohorse.com`} quote={t("share-page")}>
        <svg viewBox="0 0 64 64" width="32" height="32">
          <g>
      ...
      <EmailShareButton url={`https://xgohorse.com`} quote={t("share-page")}>
        <svg viewBox="0 0 64 64" width="32" height="32">
          <g>
...
export default withTranslation("share")(SharePage);
